            ...
            <div id="pageheader-container" className="flex items-center justify-between p-4 mb-2">
                <div id="pageheader-left" className="flex flex-col">
                    ...
                    <div id="breadcrumb-links" className="flex items-center font-medium space-x-1 mt-1 text-xs text-gray-400">
                        <span className="cursor-pointer hover:text-hijau transition">Home</span>
                        <span>/</span>
                        <span className="cursor-pointer hover:text-hijau transition">Home Detail</span>
                        <span>/</span>
                        <span className="text-gray-600 font-bold">Dashboard Very Detail</span>
                    </div>
                </div>
